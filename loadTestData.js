/* ************************************** */
//Use this file to initialize your MongoDB
//Run only once using 'babel-node loadTestData.js' in the command line.
/* ************************************** */
...
//Connect to database
//Specify to use the latest supported UrlParser. 
MongoClient.connect(config.mongodbUri, { useNewUrlParser: true }, (err, client) => {
  ...
  //This client.db syntax must be used with mongodb driver version 3.x.x+
  const db = client.db('test');

  //Insert data into the collection 'contests'
